...
; this 49A1 is wrong ^^^^ it should be 49A0
...
#_00D46C: CMP.b #$01 ; FOLLOWER 01
#_00D46E: BEQ .start

#_00D470: LDY.b #$66
#_00D472: LDA.l $7EF3CC
#_00D476: CMP.b #$09 ; FOLLOWER 09
#_00D478: BCC .start
...
#_00DAAD: CMP.b #$40 ; OW 40
#_00DAAF: BEQ .subscreen

#_00DAB1: CMP.b #$5B ; OW 5B
#_00DAB3: BEQ .subscreen

#_00DAB5: CMP.b #$03 ; OW 03
#_00DAB7: BEQ .subscreen

#_00DAB9: CMP.b #$05 ; OW 05
#_00DABB: BEQ .subscreen

#_00DABD: CMP.b #$07 ; OW 07
#_00DABF: BEQ .subscreen

#_00DAC1: CMP.b #$43 ; OW 43
#_00DAC3: BEQ .subscreen

#_00DAC5: CMP.b #$45 ; OW 45
#_00DAC7: BEQ .subscreen

#_00DAC9: CMP.b #$47 ; OW 47
...
SheetsTable_AA3:
#_00DB97: db $00, $49, $00, $00 ; 0x00
#_00DB9B: db $46, $49, $0C, $1D ; 0x01
#_00DB9F: db $48, $49, $13, $1D ; 0x02
#_00DBA3: db $46, $49, $13, $0E ; 0x03
#_00DBA7: db $48, $49, $0C, $11 ; 0x04
#_00DBAB: db $48, $49, $0C, $10 ; 0x05
#_00DBAF: db $4F, $49, $4A, $50 ; 0x06
#_00DBB3: db $0E, $49, $4A, $11 ; 0x07
#_00DBB7: db $46, $49, $12, $00 ; 0x08
#_00DBBB: db $00, $49, $00, $50 ; 0x09
#_00DBBF: db $00, $49, $00, $11 ; 0x0A
#_00DBC3: db $48, $49, $0C, $00 ; 0x0B
#_00DBC7: db $00, $00, $37, $36 ; 0x0C
#_00DBCB: db $48, $49, $4C, $11 ; 0x0D
#_00DBCF: db $5D, $2C, $0C, $44 ; 0x0E
#_00DBD3: db $00, $00, $4E, $00 ; 0x0F
#_00DBD7: db $0F, $00, $12, $10 ; 0x10
#_00DBDB: db $00, $00, $00, $4C ; 0x11
#_00DBDF: db $00, $0D, $17, $00 ; 0x12
#_00DBE3: db $16, $0D, $17, $1B ; 0x13
#_00DBE7: db $16, $0D, $17, $14 ; 0x14
#_00DBEB: db $15, $0D, $17, $15 ; 0x15
#_00DBEF: db $16, $0D, $18, $19 ; 0x16
#_00DBF3: db $16, $0D, $17, $19 ; 0x17
#_00DBF7: db $16, $0D, $00, $00 ; 0x18
#_00DBFB: db $16, $0D, $18, $1B ; 0x19
#_00DBFF: db $0F, $49, $4A, $11 ; 0x1A
#_00DC03: db $4B, $2A, $5C, $15 ; 0x1B
#_00DC07: db $16, $49, $17, $1D ; 0x1C
#_00DC0B: db $00, $00, $00, $15 ; 0x1D
#_00DC0F: db $16, $0D, $17, $10 ; 0x1E
#_00DC13: db $16, $49, $12, $00 ; 0x1F
#_00DC17: db $16, $49, $0C, $11 ; 0x20
#_00DC1B: db $00, $00, $12, $10 ; 0x21
#_00DC1F: db $16, $0D, $00, $11 ; 0x22
#_00DC23: db $16, $49, $0C, $00 ; 0x23
#_00DC27: db $16, $0D, $4C, $11 ; 0x24
#_00DC2B: db $0E, $0D, $4A, $11 ; 0x25
#_00DC2F: db $16, $1A, $17, $1B ; 0x26
#_00DC33: db $4F, $34, $4A, $50 ; 0x27
#_00DC37: db $35, $4D, $65, $36 ; 0x28
#_00DC3B: db $4A, $34, $4E, $00 ; 0x29
#_00DC3F: db $0E, $34, $4A, $11 ; 0x2A
#_00DC43: db $51, $34, $5D, $59 ; 0x2B
#_00DC47: db $4B, $49, $4C, $11 ; 0x2C
#_00DC4B: db $2D, $00, $00, $00 ; 0x2D
#_00DC4F: db $5D, $00, $12, $59 ; 0x2E
#_00DC53: db $00, $00, $00, $00 ; 0x2F
#_00DC57: db $00, $00, $00, $00 ; 0x30
#_00DC5B: db $00, $00, $00, $00 ; 0x31
#_00DC5F: db $00, $00, $00, $00 ; 0x32
#_00DC63: db $00, $00, $00, $00 ; 0x33
#_00DC67: db $00, $00, $00, $00 ; 0x34
#_00DC6B: db $00, $00, $00, $00 ; 0x35
#_00DC6F: db $00, $00, $00, $00 ; 0x36
#_00DC73: db $00, $00, $00, $00 ; 0x37
#_00DC77: db $00, $00, $00, $00 ; 0x38
#_00DC7B: db $00, $00, $00, $00 ; 0x39
#_00DC7F: db $00, $00, $00, $00 ; 0x3A
#_00DC83: db $00, $00, $00, $00 ; 0x3B
#_00DC87: db $00, $00, $00, $00 ; 0x3C
...
SheetsTable_AA2:
; Underworld
#_00DDD7: db $06, $00, $1F, $18 ; 0x00
#_00DDDB: db $08, $00, $22, $1B ; 0x01
#_00DDDF: db $06, $00, $1F, $18 ; 0x02
#_00DDE3: db $07, $00, $23, $1C ; 0x03
#_00DDE7: db $07, $00, $21, $18 ; 0x04
#_00DDEB: db $09, $00, $20, $19 ; 0x05
#_00DDEF: db $0B, $00, $21, $1A ; 0x06
#_00DDF3: db $0C, $00, $24, $19 ; 0x07
#_00DDF7: db $08, $00, $22, $1B ; 0x08
#_00DDFB: db $0C, $00, $25, $1B ; 0x09
#_00DDFF: db $0C, $00, $26, $1B ; 0x0A
#_00DE03: db $0A, $00, $27, $1D ; 0x0B
#_00DE07: db $0A, $00, $28, $1E ; 0x0C
#_00DE0B: db $0B, $00, $29, $16 ; 0x0D
#_00DE0F: db $0D, $00, $2A, $18 ; 0x0E
#_00DE13: db $07, $00, $23, $1C ; 0x0F
#_00DE17: db $07, $00, $04, $05 ; 0x10
#_00DE1B: db $07, $00, $04, $05 ; 0x11
#_00DE1F: db $09, $00, $20, $1B ; 0x12
#_00DE23: db $09, $00, $2A, $17 ; 0x13
#_00DE27: db $0B, $00, $21, $1C ; 0x14
#_00DE2B: db $09, $00, $20, $19 ; 0x15
#_00DE2F: db $0B, $00, $21, $1A ; 0x16
#_00DE33: db $09, $00, $24, $1B ; 0x17
#_00DE37: db $08, $00, $22, $1B ; 0x18
#_00DE3B: db $09, $00, $25, $1B ; 0x19
#_00DE3F: db $09, $00, $26, $1B ; 0x1A
#_00DE43: db $0A, $00, $27, $1D ; 0x1B
#_00DE47: db $09, $00, $28, $1E ; 0x1C
#_00DE4B: db $0C, $00, $29, $16 ; 0x1D
#_00DE4F: db $0D, $00, $2A, $17 ; 0x1E
#_00DE53: db $72, $00, $2B, $5D ; 0x1F

; Overworld
#_00DE57: db $00, $00, $00, $00 ; 0x20
#_00DE5B: db $00, $57, $4C, $00 ; 0x21
#_00DE5F: db $00, $56, $4F, $00 ; 0x22
#_00DE63: db $00, $53, $4D, $00 ; 0x23
#_00DE67: db $00, $52, $49, $00 ; 0x24
#_00DE6B: db $00, $55, $4A, $00 ; 0x25
#_00DE6F: db $00, $53, $54, $00 ; 0x26
#_00DE73: db $00, $51, $4E, $00 ; 0x27
#_00DE77: db $00, $00, $00, $00 ; 0x28
#_00DE7B: db $00, $50, $4B, $00 ; 0x29
#_00DE7F: db $00, $53, $4D, $00 ; 0x2A
#_00DE83: db $00, $55, $54, $00 ; 0x2B
#_00DE87: db $00, $00, $00, $00 ; 0x2C
#_00DE8B: db $00, $00, $00, $00 ; 0x2D
#_00DE8F: db $00, $00, $00, $00 ; 0x2E
#_00DE93: db $00, $47, $48, $00 ; 0x2F
#_00DE97: db $00, $00, $00, $00 ; 0x30
#_00DE9B: db $00, $57, $4C, $00 ; 0x31
#_00DE9F: db $00, $56, $4F, $00 ; 0x32
#_00DEA3: db $00, $53, $4D, $00 ; 0x33
#_00DEA7: db $00, $52, $49, $00 ; 0x34
#_00DEAB: db $00, $55, $4A, $00 ; 0x35
#_00DEAF: db $00, $53, $54, $00 ; 0x36
#_00DEB3: db $00, $51, $4E, $00 ; 0x37
#_00DEB7: db $00, $00, $00, $00 ; 0x38
#_00DEBB: db $00, $50, $4B, $00 ; 0x39
#_00DEBF: db $00, $53, $00, $00 ; 0x3A
#_00DEC3: db $00, $35, $36, $00 ; 0x3B
#_00DEC7: db $00, $60, $34, $00 ; 0x3C
#_00DECB: db $00, $2B, $2C, $00 ; 0x3D
#_00DECF: db $00, $2D, $2E, $00 ; 0x3E
#_00DED3: db $00, $2F, $30, $00 ; 0x3F
#_00DED7: db $00, $37, $38, $00 ; 0x40
#_00DEDB: db $00, $33, $34, $00 ; 0x41
#_00DEDF: db $00, $31, $32, $00 ; 0x42
#_00DEE3: db $00, $00, $00, $00 ; 0x43
#_00DEE7: db $00, $00, $00, $00 ; 0x44
#_00DEEB: db $00, $00, $00, $00 ; 0x45
#_00DEEF: db $00, $00, $00, $00 ; 0x46
#_00DEF3: db $00, $00, $00, $00 ; 0x47
#_00DEF7: db $00, $00, $00, $00 ; 0x48
#_00DEFB: db $00, $00, $00, $00 ; 0x49
#_00DEFF: db $00, $00, $00, $00 ; 0x4A
#_00DF03: db $00, $00, $00, $00 ; 0x4B
#_00DF07: db $00, $00, $00, $00 ; 0x4C
#_00DF0B: db $00, $00, $00, $00 ; 0x4D
#_00DF0F: db $00, $00, $00, $00 ; 0x4E
#_00DF13: db $00, $00, $00, $00 ; 0x4F
#_00DF17: db $72, $71, $72, $71 ; 0x50
#_00DF1B: db $72, $40, $41, $39 ; 0x51
...
#_00DF20: db $51 ; VRAM $A200
#_00DF21: db $52 ; VRAM $A400
#_00DF22: db $53 ; VRAM $A600
#_00DF23: db $54 ; VRAM $A800
#_00DF24: db $55 ; VRAM $AA00
#_00DF25: db $56 ; VRAM $AC00
#_00DF26: db $57 ; VRAM $AE00
#_00DF27: db $58 ; VRAM $B000
#_00DF28: db $59 ; VRAM $B200
#_00DF29: db $5A ; VRAM $B400
#_00DF2A: db $5B ; VRAM $B600
#_00DF2B: db $5C ; VRAM $B800
#_00DF2C: db $5D ; VRAM $BA00
#_00DF2D: db $5E ; VRAM $BC00
#_00DF2E: db $5F ; VRAM $BE00
...
SheetsTable_AA1:
; Underworld
#_00E0B3: db $00, $01, $10, $06, $0E, $1F, $18, $0F ; 0x00
#_00E0BB: db $00, $01, $10, $08, $0E, $22, $1B, $0F ; 0x01
#_00E0C3: db $00, $01, $10, $06, $0E, $1F, $18, $0F ; 0x02
#_00E0CB: db $00, $01, $13, $07, $0E, $23, $1C, $0F ; 0x03
#_00E0D3: db $00, $01, $10, $07, $0E, $21, $18, $0F ; 0x04
#_00E0DB: db $00, $01, $10, $09, $0E, $20, $19, $0F ; 0x05
#_00E0E3: db $02, $03, $12, $0B, $0E, $21, $1A, $0F ; 0x06
#_00E0EB: db $00, $01, $11, $0C, $0E, $24, $1B, $0F ; 0x07
#_00E0F3: db $00, $01, $11, $08, $0E, $22, $1B, $0F ; 0x08
#_00E0FB: db $00, $01, $11, $0C, $0E, $25, $1A, $0F ; 0x09
#_00E103: db $00, $01, $11, $0C, $0E, $26, $1B, $0F ; 0x0A
#_00E10B: db $00, $01, $14, $0A, $0E, $27, $1D, $0F ; 0x0B
#_00E113: db $00, $01, $11, $0A, $0E, $28, $1E, $0F ; 0x0C
#_00E11B: db $02, $03, $12, $0B, $0E, $29, $16, $0F ; 0x0D
#_00E123: db $00, $01, $15, $0D, $0E, $2A, $18, $0F ; 0x0E
#_00E12B: db $00, $01, $10, $07, $0E, $23, $1C, $0F ; 0x0F
#_00E133: db $00, $01, $13, $07, $0E, $04, $05, $0F ; 0x10
#_00E13B: db $00, $01, $13, $07, $0E, $04, $05, $0F ; 0x11
#_00E143: db $00, $01, $10, $09, $0E, $20, $1B, $0F ; 0x12
#_00E14B: db $00, $01, $10, $09, $0E, $2A, $17, $0F ; 0x13
#_00E153: db $02, $03, $12, $0B, $0E, $21, $1C, $0F ; 0x14

#_00E15B: db $00, $08, $11, $1B, $22, $2E, $5D, $5B ; 0x15
#_00E163: db $00, $08, $10, $18, $20, $2B, $5D, $5B ; 0x16
#_00E16B: db $00, $08, $10, $18, $20, $2B, $5D, $5B ; 0x17

; Overworld
#_00E173: db $3A, $3B, $3C, $3D, $53, $4D, $3E, $5B ; 0x18
#_00E17B: db $42, $43, $44, $45, $20, $2B, $3F, $5D ; 0x19
#_00E183: db $00, $08, $10, $18, $20, $2B, $5D, $5B ; 0x1A
#_00E18B: db $00, $08, $10, $18, $20, $2B, $5D, $5B ; 0x1B
#_00E193: db $00, $08, $10, $18, $20, $2B, $5D, $5B ; 0x1C
#_00E19B: db $00, $08, $10, $18, $20, $2B, $5D, $5B ; 0x1D
#_00E1A3: db $00, $08, $10, $18, $20, $2B, $5D, $5B ; 0x1E
#_00E1AB: db $71, $72, $71, $72, $20, $2B, $5D, $5B ; 0x1F
#_00E1B3: db $3A, $3B, $3C, $3D, $53, $4D, $3E, $5B ; 0x20
#_00E1BB: db $42, $43, $44, $45, $20, $2B, $3F, $59 ; 0x21
#_00E1C3: db $00, $72, $71, $72, $20, $2B, $5D, $0F ; 0x22
#_00E1CB: db $00, $39, $39, $72, $40, $41, $39, $0F ; 0x23
...
#_00E3E2: STZ.w VMADDL ; VRAM $0000
...
#_00E81B: ASL A
#_00E81C: BPL .repeating_byte

#_00E81E: ASL A
#_00E81F: BPL .repeating_word
...
#_00F3FA: LDA.b $8A
#_00F3FC: CMP.b #$43 ; OW 43
#_00F3FE: BEQ .dark_dm

#_00F400: CMP.b #$45 ; OW 45
#_00F402: BEQ .dark_dm

#_00F404: CMP.b #$47 ; OW 47
#_00F406: BNE .check_music_command

.dark_dm
#_00F408: LDA.b #$09 ; SFX1.09
#_00F40A: STA.w $012D

.check_music_command
#_00F40D: LDA.w $0132
#_00F410: CMP.b #$FF ; SONG FF - transfer
